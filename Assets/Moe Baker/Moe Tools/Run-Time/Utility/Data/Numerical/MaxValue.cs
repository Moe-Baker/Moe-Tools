...
namespace Moe.Tools
{
    ...
    [Serializable]
    public class IntMaxValue : MaxValue<int>, IIntRange
    {
        ...
        public IntMaxValue(int value) : base(value)
        {

        }
        public IntMaxValue(int value, int max) : base(value, max)
        {
    ...
    [Serializable]
    public class FloatMaxValue : MaxValue<float>, IFloatRange
    {
        ...
        public FloatMaxValue(float value) : base(value)
        {

        }
        public FloatMaxValue(float value, float max) : base(value, max)
        {
